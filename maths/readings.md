+++
title = "Readings in Higher Maths"
hascode = true
date = Date(2022, 12, 17)
rss = "An infinite napkin with notes on General System Theory, and Category Theory. It also features notes from the PhD theses of  Tai Danae Bradley and Elie Adam."

tags = ["System Theory", "Generative Effects", "Emergent Effects"]
+++


# Readings in Higher Maths
...
## Notes from TDB's "At the Interface of Algebra and Statistics"
...
## Notes from E. Adam's "Systems, Generativity and Interactional Effects"
